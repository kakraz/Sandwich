...
public class SandwichWorker {
    public void createSandwich(Connection connection, Integer id, String name, String type, Integer minutes,
    ...
    public void deleteSandwich(Connection connection, Integer id) throws SQLException {
    ...
    public Sandwiches getSandwichById(Connection connection, Integer id) throws SQLException {
    ...
    public Sandwiches getSandwichByType(Connection connection, String type) throws SQLException {
    ...
    public Sandwiches getSandwichByIdAndType(Connection connection, Integer id, String type) throws SQLException {
    ...
    public List<Sandwiches> getSandwichByIngredient(Connection connection, Integer comp_id) throws SQLException {
